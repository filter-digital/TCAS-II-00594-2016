...
# ACDS 16.0 211 win32 2016.08.02.14:26:29
...
# ----------------------------------------
# If FIR_90TAPS is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_rtl_core.vhd"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_ast.vhd"                             
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS.vhd"                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_tb.vhd"                              
fi
