...
# ----------------------------------------
# ACDS 16.0 211 win32 2016.08.02.14:26:28
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_rtl_core.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_ast.vhd"                             
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS.vhd"                                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_90TAPS_tb.vhd"                              
}
