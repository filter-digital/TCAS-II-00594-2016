...
transcript on
write transcript FIR_90TAPS_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity FIR_90TAPS
set timing_resolution "1ps"
set core_version 15.1
set device_family CYCLONEV
set quartus_rootdir C:/altera_lite/15.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists FIR_90TAPS.vo]} {vlog -work work FIR_90TAPS.vo} else {
    	vcom -93 -work work FIR_90TAPS.vho
	}
